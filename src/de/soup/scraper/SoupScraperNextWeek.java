...
public class SoupScraperNextWeek {

	private Writer output;
	private final String URL = "http://suppenladen.com/index.php/naechstewoche.html";
	...
	public void scrape() {
		...
		try {
			...
			Document sourceDoc = db.parse(new InputSource(new StringReader(
					output.toString())));
			Document xslDoc = db.parse(new File("files/transform_nextweek.xsl"));
			...
			SoupDAO.getInstance().setNextWeek(sw.toString());
